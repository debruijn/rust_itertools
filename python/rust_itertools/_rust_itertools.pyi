...
def derangements(iterable: Iterable[Any], k: int | None) -> list[list[Any]]: ...
def permutations(iterable: Iterable[Any], k: int | None) -> list[list[Any]]: ...
def distinct_permutations(iterable: Iterable[Any], k: int | None) -> list[list[Any]]: ...
